define(["jquery", "jquery-ui", "spectrum"], function (jquery, jui, spectrum) {
	var setting = {};
	setting.init = init;
	function init(){
		/*
		$("#p-set").on("click", pageSetting);
		...
		$("#settingApply").on("click", function(){
			var currentProfile = $("[currentProfile*=true]");
			var width = $("#page-setting").attr("value_width");
			var height = $("#page-setting").attr("value_height");
			var color = $("#page-setting").attr("value_color");
			currentProfile.css({
				width : width,
				height : height,
