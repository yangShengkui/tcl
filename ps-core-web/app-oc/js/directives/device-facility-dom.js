                                    ...
                                    if (api.data().length > 0) {
                                        ...
                                        $.fn.dataTable.ext.buttons.addnew = {
                                            ...
                                            action: function (e, dt, node, config) {
                                                window.location.href = '#/facility/add_device';
                                            }
                                        };
                                        new $.fn.dataTable.Buttons(table, {
                                            buttons: $scope.buttons(exportOptionsCol)
                                        });
...
//                $(".dataTables_wrapper .col-sm-6").hide()
  ...
  directives.initDirective('pointAccessTable', ['$timeout', '$compile', 'growl', function($timeout, $compile, growl) {
    ...
    directives.initDirective('facilityBookInfoTable', ['$timeout', '$compile', '$filter', 'growl', 'weatherService', 'actionService', function ($timeout, $compile, $filter, growl, weatherService, actionService) {
        return {
            restrict: 'A',
            controller: ['$scope', '$element', '$attrs',
                function ($scope, $element, $attrs) {
